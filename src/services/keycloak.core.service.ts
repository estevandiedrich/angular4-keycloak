...
export class Keycloak {
    ...
    static adapter:any = undefined;
    static resourceAccess:any = undefined;
    static callback_id:number = 0;
    static loginIframe:LoginIframe = undefined;
    static callbackStorage:any = undefined;
    static timeSkew:number = 0;
    static http:Http = undefined;
    static loginRequired:boolean = undefined;

    // Token objects
    static tokenParsed:any = undefined;
    static idTokenParsed:any = undefined;
    static refreshTokenParsed:any = undefined;
    static accessToken:string = undefined;
    static idToken:string = undefined;
    static refreshToken:string = undefined;
    static tokenTimeoutHandle:any = undefined;
    static subject:string = undefined;
    static sessionId:string = undefined;


    // OIDC client properties
    static responseMode:string = undefined;
    static responseType:string = undefined;
    static flow:string = undefined;
    static clientId:string = undefined;
    static clientSecret:string = undefined;
    static authServerUrl:string = undefined;
    static realm:string = undefined;
    static realmAccess:any = undefined;
